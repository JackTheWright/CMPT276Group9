...
class barChartView: UIViewController {
    ...
    func generateDataEntries() -> [BarEntry] {
        ...
        var result: [BarEntry] = []
        let meatVal = Int(UserDefaults.standard.string(forKey: "meatTotal")!)
        let vegVal = Int(UserDefaults.standard.string(forKey: "vegetableTotal")!)
        let fruVal = Int(UserDefaults.standard.string(forKey: "fruitTotal")!)
        let daiVal = Int(UserDefaults.standard.string(forKey: "dairyTotal")!)
        let graVal = Int(UserDefaults.standard.string(forKey: "grainsTotal")!)
        
        let meastring = UserDefaults.standard.string(forKey: "meatTotal")
        let vegstring = UserDefaults.standard.string(forKey: "vegetableTotal")
        let frustring = UserDefaults.standard.string(forKey: "fruitTotal")
        let daistring = UserDefaults.standard.string(forKey: "dairyTotal")
        let grastring = UserDefaults.standard.string(forKey: "grainsTotal")
