...
class barChartView: UIViewController {
    ...
    func generateDataEntries() -> [BarEntry] {
        ...
        let meatVal = Int(UserDefaults.standard.string(forKey: "meatTotal")!) ?? 0
        let vegVal = Int(UserDefaults.standard.string(forKey: "vegetableTotal")!) ?? 0
        let fruVal = Int(UserDefaults.standard.string(forKey: "fruitTotal")!) ?? 0
        let daiVal = Int(UserDefaults.standard.string(forKey: "dairyTotal")!) ?? 0
        let graVal = Int(UserDefaults.standard.string(forKey: "grainsTotal")!) ?? 0
